...
[assembly: Addin("NeverWorldSearch", OpenSim.VersionInfo.VersionNumber + "0.4")]
[assembly: AddinDependency("OpenSim.Region.Framework", OpenSim.VersionInfo.VersionNumber)]
[assembly: AddinDescription("NeverWorldSearch module.")]
[assembly: AddinAuthor("Cody Cooper")]


namespace NeverWorldSearch.Modules.OpenSearch
{
    [Extension(Path = "/OpenSim/RegionModules", NodeName = "RegionModule", Id = "NeverWorldSearch")]
    public class OpenSearchModule : ISearchModule, ISharedRegionModule
    {
        ...
        public void Initialise(IConfigSource config)
        {
            ...
            if (searchConfig.GetString("Module", "NeverWorldSearch") != "NeverWorldSearch")
            {
                m_Enabled = false;
                return;
            }
            ...
            m_log.Info("[SEARCH] NeverWorldSearch module is active");
            m_Enabled = true;
        }
